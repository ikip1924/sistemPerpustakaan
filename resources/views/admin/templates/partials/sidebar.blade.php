<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <li><a href="{{ route('admin.borrow.index')}}"><i class="fa fa-book"></i> <span>Buku Sedang Di pinjam</span></a></li>
    <li class="treeview">
      <a href="#">
    ...
    <a href="https://adminlte.io/docs"><i class="fa fa-users"></i> <span>User</span></a></>
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>
